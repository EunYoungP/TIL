...
안정 정렬이 필요하고, 입력 개체가 매우 작을 때 사용합니다.

퀵 정렬/병합 정렬의 내부 정렬에서 사용합니다.

입력 크기가 작을 때는 병합 정렬/퀵 정렬보다 더 나은 성능을 보여줍니다.

데이터가 이미 정렬된 경우, O(n)의 실행시간을 가집니다.<BR><BR>

__버블 정렬__

데이터가 거의 정렬된 경우에 사용합니다.

향상된 버블 정렬로 더 나은 성능을 보여줍니다.<br><Br>

__선택 정렬__

빠른 작업을 원할 경우, 프로토타입을 만들 경우 유용합니다.<br><br>

__카운트 정렬__

제한된 범위 내의 데이터를 정렬하는데 사용합니다.<br><br>

__버킷 정렬__

입력이 어느 정도 균등하게 분포할 때 사용합니다.
